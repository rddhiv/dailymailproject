...
@Given("^User Click on the Webpage \"([^\"]*)\"$")
public void user_click_on_the_webpage(String arg1) 
{
	login.loginWebpage(arg1);
...
public void user_can_able_to_view_sports_tab_in_the_webpage_and_click_on_the_tab() {
	login.verifySportandFootballColor();
}
...
public void ensure_video_can_be_viewed_in_full_screen_and_minimized() {
	...
	login.viewMaximizeMinimizeVideo();
}
...
public void navigate_to_the_bottom_right_of_the_article_page_to_the_premier_league_table_section() {
	login.clickPremierLeagueTable();
}

@And("exhibit the points or positions from the Premier league table")
public void exhibit_the_points_or_positions_from_the_premier_league_table() {
	login.checkPositionofPLT();
}
